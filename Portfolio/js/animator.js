...
skill6 = skillHeaders[5];
skill7 = skillHeaders[6];
skill8 = skillHeaders[7];
...
prog6 = progressBars[5];
prog7 = progressBars[6];
prog8 = progressBars[7];
...
interskilljs = setInterval(
  () => skillChanger(skill6, prog6, interskilljs),
  300
);
interskilljs = setInterval(
  () => skillChanger(skill7, prog7, interskilljs),
  300
);
interskilljs = setInterval(
  () => skillChanger(skill8, prog8, interskilljs),
  300
);
